...
class Pulsa extends Component {
    ...
    state = {
        provider: [
            { id: 1, nama: '3(three)' },
            { id: 2, nama: 'Indosat Ooreedoo' },
            { id: 3, nama: 'Simpati (Telkomsel)' },
            { id: 4, nama: 'Smartfren' },
            { id: 5, nama: 'XL/Axis' }
        ]
    }
        ...
        return (
            <View style={{ flex: 1, alignItems: "center" }}>
                <View style={{ borderWidth: 0, width: '100%', height: 50, backgroundColor: '#f0f0f0', alignItems: 'flex-start', justifyContent: 'center' }}>
                    <Text style={{ marginLeft: 20, fontSize: 16 }}>Provider handphone</Text>
                </View>
                {this.renderMain()}
            </View>
        )
...
export default connect(null, null)(Pulsa);